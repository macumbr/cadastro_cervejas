defmodule CadastroCervejasWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CadastroCervejasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CadastroCervejasWeb.Gettext, "errors", msg, opts)
    end
  end
